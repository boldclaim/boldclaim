---
title: Migration - Fakten gegen Vorurteile
type: note
last_updated: 2026-04-07
tags: ["personal"]
---

# Migration - Fakten gegen Vorurteile

> Statistiken, Wirtschaftsdaten, Kriminalitätszahlen - alles mit Quellen

---

## Schnellnavigation

- [[#Deutschland wird unsicherer - Der große Mythos]]
...
| 2024 | **~0,9** | 730 Tötungsdelikte insgesamt (222 vollendete Morde + 508 Versuche); vollendete Morde allein: ~0,26 pro 100.000 |
...
**Quellen:**
- [World Bank: Intentional Homicides Germany](https://data.worldbank.org/indicator/VC.IHR.PSRC.P5?locations=DE)
- [BKA Polizeiliche Kriminalstatistik](https://www.bka.de/DE/AktuelleInformationen/StatistikenLagebilder/PolizeilicheKriminalstatistik/pks_node.html)
- [SDG-Indikator 16.1.1 Deutschland](https://sdg-indikatoren.de/en/16-1-1/)
...
**Quellen:**
- [Macrotrends: Germany Murder Rate](https://www.macrotrends.net/global-metrics/countries/deu/germany/murder-homicide-rate)
- [Everytown: Gunfire on School Grounds](https://everytownresearch.org/maps/gunfire-on-school-grounds/)
- [Wikipedia: List of countries by intentional homicide rate](https://en.wikipedia.org/wiki/List_of_countries_by_intentional_homicide_rate)

### ifo-Studie 2025: Mehr Ausländer ≠ Mehr Kriminalität

**Studie:** Alipour & Adema, ifo Institut, Februar 2025
**Methode:** PKS-Daten 2018–2023, Analyse nach Landkreisen
...
**Zitat:** _"Wir finden keinen Zusammenhang zwischen einem steigenden Ausländeranteil in einem Kreis und der lokalen Kriminalitätsrate"_ — Dr. Jean-Victor Alipour

**Quellen:**
- [ifo Pressemitteilung](https://www.ifo.de/en/press-release/2025-02-18/more-foreigners-do-not-increase-germanys-crime-rate)
- [ifo Schnelldienst Digital 3/2025 (PDF)](https://www.ifo.de/DocDL/sd-2025-digital-03-adema-alipour-migration-kriminalitaet.pdf)

### Medien-Bias: Die "Migrantisierung" der Kriminalität

**Studie:** Thomas Hestermann, Macromedia Hochschule Hamburg, 2025
**Auftraggeber:** Mediendienst Integration

**Kernergebnisse:**
- Ausländische Tatverdächtige werden **~3x häufiger** namentlich genannt als ihr Anteil in der PKS
- Wenn Herkunft erwähnt wird: **94,6% der genannten Verdächtigen sind nicht-deutsch** — aber nur **34,3%** der tatsächlichen Tatverdächtigen sind Ausländer
...
**Quellen:**
- [InfoMigrants: German media bias falsely inflates crime by foreigners](https://www.infomigrants.net/en/post/67603/german-media-bias-falsely-inflates-crime-by-foreigners)
- [CEPII Working Paper: The Usual Suspects (PDF)](https://www.cepii.fr/PDF_PUB/wp/2022/wp2022-10.pdf)
...
**Warum:**
1. Die Zahl 58,5% (111.517 von 190.695 Verdächtigen) bezog sich auf **deutsche Staatsbürger**, nicht auf Migranten
2. Der n-tv-Journalist, der die Statistik ursprünglich berichtete, korrigierte den Fehler
3. Die deutsche Polizeistatistik erfasst gar keinen "Migrationshintergrund" — nur Staatsangehörigkeit

**Quelle:** [EUfactcheck.eu: FALSE](https://eufactcheck.eu/factcheck/false-almost-60-of-violent-crimes-in-germany-are-committed-by-men-with-migrant-background/)

### PKS 2024: Die tatsächlichen Zahlen (Tatverdächtige, nicht Verurteilte)

| Kategorie | Anteil an Tatverdächtigen | Hinweis |
|-----------|--------------------------|---------|
| Deutsche Staatsangehörige | **64,6%** | inkl. Eingebürgerte |
| Nicht-Deutsche gesamt | 35,4% | inkl. EU-Bürger, Touristen, Transitreisende |
| Davon temporäre Migranten (Asylsuchende etc.) | **8,8%** | Anteil an ALLEN Tatverdächtigen |
| Temporäre Migranten bei Tötungsdelikten | ~12% | erhöht, aber absolute Zahlen klein |
| *Caveat* | *Tatverdächtige ≠ Verurteilte* | *Anzeigeverhalten gegenüber als fremd wahrgenommenen Tätern doppelt so hoch* |

**Quelle:** [InfoMigrants: Germany temporary migrants 8.8%](https://www.infomigrants.net/en/post/68688/germany-temporary-migrants-account-for-88-of-suspects)
...
Tötungsrate 2024: ~0,9 pro 100.000
...
**Quelle:** [BKA Bundeslagebild](https://www.bka.de/DE/AktuelleInformationen/StatistikenLagebilder/Lagebilder/lagebilder_node.html)
...
**Belastungszahl 2024 (Tatverdächtige, nicht Verurteilte):** 5.091 je 100.000 Ausländer vs. 1.878 je 100.000 Deutsche (Faktor 2,7 — vor jeder Bereinigung). Nach Bereinigung um Ausländerrechtsdelikte (können nur Nicht-Deutsche begehen), Alters-/Geschlechtsstruktur und Wohnortlosigkeit schrumpft dieser Abstand erheblich. Aufenthaltsstatus, nicht Herkunft, ist der primäre Risikofaktor (KFN 2019, SVR 2024).
...
### PKS 2024: Tatverdächtigenbelastungszahl nach Delikt (Tatverdächtige, nicht Verurteilte; ohne Aufenthaltsstatus-Kontrolle)
...
**TVBZ Gewaltkriminalität nach Staatsangehörigkeit (Tatverdächtige, nicht Verurteilte; ohne Aufenthaltsstatus-Kontrolle) — [PRÜFEN: Bundestag-Drucksachennummer nicht verifiziert, eigene Berechnung PKS 2024 + AZR]:**

| Staatsangehörigkeit | TVBZ Gewalt | Hinweis |
|---------------------|-------------|---------|
| Deutsche | 163 | Vergleichsbasis |
| Ukrainer | 443 | Großteil Schutzberechtigte (gesicherter Status) |
| Polen | 427 | EU-Bürger, niedrige Schutzbedürftigkeit |
| Türken | 538 | Großteil langjährig integriert |
| Iraker | 1.606 | Mix aus Schutzstatus; KFN: Duldungsstatus erhöht Risiko |
| Afghanen | 1.722 | Hoher Anteil Geduldete; KFN: Aufenthaltsunsicherheit als kriminogener Faktor |
| Syrer | 1.740 | Ähnlich; KFN 2019: Gradient läuft am Rechtsstatus, nicht an Herkunft |
| Marokkaner | 1.885 | Hoher Anteil ohne gesicherten Status; Beschäftigungsverbote wirken kriminogen |
| *Caveat* | *Tatverdächtige/100k, nicht Verurteilte* | *Aufenthaltsstatus (nicht Herkunft) ist primärer Risikofaktor (KFN 2019, SVR 2024). Anzeigerate bei fremd wahrgenommenen Tätern doppelt so hoch.* |
...
Trend: ND pro Kopf minus 21% seit 2014. DE pro Kopf minus 20%. Beide fallen parallel, Faktor stabil ~2,8x. Der Abstand erklärt sich zu einem erheblichen Teil durch Alters- und Geschlechtsstruktur (Geflüchtete überproportional jung + männlich), nicht durch Herkunft.
...
- Eigene Berechnung aus PKS 2024 (BKA Tabellen T40/T50) + AZR (Destatis) [Bundestag-Drucksachennummer nicht verifiziert, PRÜFEN]
...
**Quelle:** [Bundestag: §184i und §184j StGB](https://www.bundestag.de/webarchiv/textarchiv/2016/kw27-de-selbstbestimmung-434214)
...
- Arbeitnehmer mit Migrationshintergrund leisten einen erheblichen Anteil aller Sozialversicherungsbeiträge (exakte 30%-Zahl: keine verifizierbare Primärquelle gefunden [PRÜFEN: IAB/OECD-Bericht mit Seitenzahl])
...
**Quellen:**
- [IAB: Fiskalische Bilanz der Migration](https://www.iab-forum.de)
...
- [IAB: Gesamtwirtschaftliches Stellenangebot (Gesamtschätzung inkl. nicht gemeldeter Stellen)](https://www.iab-forum.de)
- [IW Köln: Fachkräftemangel](https://www.iwkoeln.de)
...
- **50% arbeiten in systemrelevanten Berufen** (Gesundheit, Logistik, Bau, Lebensmittel)
- **30% in Engpassberufen** (hohe Nachfrage nach Arbeitskräften)
- Mehrheit inzwischen in Fachkraft-Tätigkeiten oder darüber
...
**Quellen:**
- [IAB-Kurzbericht 17/2025: "10 Jahre Fluchtmigration 2015"](https://doku.iab.de/kurzber/2025/kb2025-17.pdf) ✅ Verifiziert
- [IAB-Kurzbericht 10/2024: Arbeitsmarktintegration](https://doku.iab.de/kurzber/2024/kb2024-10.pdf) ✅ Verifiziert
- [IAB-Forum: Was Integration fördert](https://iab-forum.de/10-jahre-fluchtmigration-2015-was-integration-foerdert-und-was-sie-bremst/) ✅ Verifiziert
- [Mediendienst Integration: 10 Jahre "Wir schaffen das"](https://mediendienst-integration.de/artikel/10-jahre-wir-schaffen-das.html) ✅ Verifiziert
- [BAMF: Integrationsberichte](https://www.bamf.de)
...
**Quelle:** [Badische Zeitung](https://www.badische-zeitung.de/gut-fuers-stadtbild-junge-muslime-raeumen-in-mannheim-auf)
...
- 50% in systemrelevanten Berufen
...
**Quellen:**
- [Destatis: Bevölkerungsvorausberechnung](https://www.destatis.de)
- [Bertelsmann Stiftung: Einwanderung](https://www.bertelsmann-stiftung.de)
...
- Aber nur 34,3% der tatsächlichen Verdächtigen = Ausländer
...
IAB-Studie 2025: 64% der 2015er Geflüchteten arbeiten.
90% sozialversicherungspflichtig.
Männer: 76%, höher als deutscher Männer-Durchschnitt.
50% in systemrelevanten Berufen.
...
10 Jahre später, IAB-Studie August 2025:
- 64% Beschäftigungsquote (Gesamtbevölkerung: 70%)
- 90% sozialversicherungspflichtig
- Geflüchtete Männer: 76%, ÜBER deutschem Durchschnitt
- 50% in systemrelevanten Jobs, 30% in Engpassberufen
...
**Quellen:**
- [IAB: Lohnunterschiede Ost-West](https://www.iab.de)
- [Bundeszentrale für politische Bildung: Ostdeutschland 30 Jahre danach](https://www.bpb.de/themen/deutsche-einheit/)
...
**Quellen:**
- [Bundesregierung: Abschiebungsstatistik](https://www.bundesregierung.de)
- [BAMF: Aufenthaltsrechtliche Daten](https://www.bamf.de/DE/Themen/Statistik/statistik-node.html)
...
**Statistiken:**
- [BAMF Asylzahlen](https://www.bamf.de/DE/Themen/Statistik/statistik-node.html)
- [BKA Kriminalstatistik](https://www.bka.de)
- [Destatis Migration](https://www.destatis.de)

**Arbeitsmarkt:**
- [IAB (Institut für Arbeitsmarkt)](https://www.iab.de)
- [IAB-Kurzbericht 17/2025: 10 Jahre Fluchtmigration](https://doku.iab.de/kurzber/2025/kb2025-17.pdf) ✅ 2025-08
- [IAB-Kurzbericht 10/2024: Arbeitsmarktintegration](https://doku.iab.de/kurzber/2024/kb2024-10.pdf) ✅ 2024-04
- [IAB-Forum: Was Integration fördert](https://iab-forum.de/10-jahre-fluchtmigration-2015-was-integration-foerdert-und-was-sie-bremst/) ✅ 2025-08
- [Mediendienst Integration: 10 Jahre "Wir schaffen das"](https://mediendienst-integration.de/artikel/10-jahre-wir-schaffen-das.html) ✅ 2025-08
- [Bundesagentur für Arbeit](https://www.arbeitsagentur.de)

**Wirtschaft:**
- [OECD Migration](https://www.oecd.org/migration/)
- [IW Köln](https://www.iwkoeln.de)
...
"In die Sozialsysteme aufnehmen": Erwerbstätigenquote der 2015er-Kohorte 68%, Männer 76% (über DE-Durchschnitt 72%). 90% sozialversicherungspflichtig (IAB 2024). Die zahlen in die Systeme ein.
...
1. **ifo-Studie auf Individualebene zitieren** → Die Studie misst auf Kreisebene, nicht individuelle Kausalität. Aggregationsfehler einräumen, bevor der Gegner ihn aufdeckt.
2. **Mediendienst Integration als neutrale Quelle darstellen** → Auftraggeber der Hestermann-Studie ist der Mediendienst Integration selbst. Transparenz schlägt Verschweigen.
3. **"Deutschland ist sicher" pauschal behaupten** → Ignoriert dokumentierte lokale Hotspots. Präziser: Gesamtrate sinkend, Verteilung ungleich.
4. **Dunkelfeld nur gegen Gegner spielen** → Das Dunkelfeld-Argument schneidet in beide Richtungen. Wer es für uns ausspielt, muss erklären warum es für die andere Seite nicht gilt.
5. **"Migranten nützen der Wirtschaft" als Hauptargument** → Verwertungslogik reduziert Menschen auf Bilanzposten. Wirkt kalt, verliert Mitleser die keine Ökonomen sind.

### Fallen für Gegner

1. **"Migrationshintergrund" in der PKS zitieren** → "Migrationshintergrund" ist keine PKS-Kategorie. Wer die Zahl trotzdem nennt, erfindet Daten.
2. **Absolute Zahlen ohne Pro-Kopf-Berechnung** → Mehr Tatverdächtige bei mehr Bevölkerung ist keine Aussage. Pro-Kopf-Rate ist der einzige valide Vergleich.
3. **Anzeigeverhalten als neutrale Messung behandeln** → Dunkelfeldforschung zeigt: bei als fremd wahrgenommenem Täter fast doppelt so hohe Anzeigerate. Die PKS misst Anzeigen, nicht Taten.
4. **"Kulturkreis" als Erklärung nutzen** → Aufenthaltsstatus-Gradient widerlegt das: anerkannte Schutzberechtigte zeigen deutlich niedrigere Belastungszahlen als Geduldete. Der Gradient läuft am Rechtsstatus, nicht an der Herkunft.
